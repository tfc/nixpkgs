import ../make-test-python.nix ({ pkgs, ...} : {
  ...
  testScript = ''
    ...
    peer1.succeed('wg set wg0 peer {} allowed-ips 10.10.10.2/32 endpoint 192.168.1.2:12345 persistent-keepalive 1'.format(peer2pubkey.strip()))
    peer1.succeed('ip route replace 10.10.10.2/32 dev wg0 table main')

    peer2.succeed('wg set wg0 peer {} allowed-ips 10.10.10.1/32 endpoint 192.168.1.1:12345 persistent-keepalive 1'.format(peer1pubkey.strip()))
