import ./make-test-python.nix ({ pkgs, ...} : {
  ...
  testScript = ''
      ...
      machine.wait_until_succeeds('systemctl --user status emacs.service | grep "Active: active"')
      ...
      machine.succeed('emacsclient --eval \'(getenv "TEST_SYSTEM_VARIABLE")\' | grep -q "system variable"')
